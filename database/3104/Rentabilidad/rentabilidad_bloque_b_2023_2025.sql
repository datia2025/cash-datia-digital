...
-- Fecha de Creacion: rentabilidad_bloque_b_2023_2025.sql
BEGIN;
...
INSERT INTO insights (
    ...
    'Annual', 
    'success', 
    'Has logrado que tu operación principal de consultoría estratégica genere un margen EBITDA del 32.46% en 2023, lo cual es una cifra fenomenal que destaca la potencia de tu equipo para crear valor bruto. Este nivel de rentabilidad operativa te otorga una ventaja competitiva única para financiar nuevas iniciativas de crecimiento sin sacrificar tu liquidez inmediata.', 
    ...
    'Te sugiero que reinviertas parte de este excedente operativo en la automatización de tus reportes de gestión interna ahora mismo. Al liberar el tiempo de tus consultores senior de tareas burocráticas y repetitivas, asegurarás que este margen se mantenga e incluso crezca en el próximo ciclo, elevando la calidad de tus entregables sin incrementar tus costos fijos anuales.', 
    'Bloque B - Auditoría Anual 2023', 
    'antigravity', 
    NOW()
...
INSERT INTO insights (
    ...
    'Annual', 
    'success', 
    'Mantenes un margen bruto del 100%, lo cual es la característica ganadora de tu modelo de negocio basado puramente en el intelecto y el conocimiento estratégico. Esto significa que no tienes el lastre de costos directos de materiales o mercancías, permitiendo que todo el ingreso neto sea la semilla para cubrir tu operación y generar tu ganancia final libremente.', 
    'Al no tener costos directos variables, tu riesgo principal se traslada al tiempo ocioso de tu equipo consultor senior dentro del ejercicio. Si tus profesionales no están facturando el máximo de horas posible, tu margen bruto del 100% se queda en una cifra teórica que no se traduce en caja real, mientras que tus gastos internos de nómina administrativa siguen corriendo implacablemente.', 
    'Debes enfocarte intensamente en maximizar la tasa de aprovechamiento de tus especialistas en cada proyecto activo. Asegúrate de que cada hito de tus consultorías esté definido para ser facturado de manera acelerada y constante. Al carecer de costos de insumos físicos, tu rentabilidad bruta es infinita, pero solo se activa si logras cerrar los ciclos operativos en el tiempo pactado.', 
    'Bloque B - Auditoría Anual 2023', 
    'antigravity', 
    NOW()
) ON CONFLICT (empresa_id, indicador_key, periodo_ano, period_key) 
...
INSERT INTO insights (
    ...
    'Annual', 
    'warning', 
    'El hecho de que utilices pocos activos físicos para operar es una ventaja competitiva magistral que debes explotar para mejorar este ratio con rapidez. Al no tener grandes inversiones en maquinaria pesada, cualquier incremento marginal en tus utilidades tendrá un impacto directo en la rentabilidad sobre tus activos totales, demostrando que tu empresa es una maquinaria ágil para producir riqueza real.', 
    'Un ROA negativo del -11.36% indica que tus activos actuales no están siendo gestionados con la eficiencia necesaria para producir beneficios tangibles para los socios. Tienes recursos dentro de la empresa que, en lugar de estar trabajando para generar el retorno que esperas, están permaneciendo inactivos o consumiendo valor sin retornar una utilidad operativa que justifique su permanencia en el balance.', 
...
INSERT INTO insights (
    ...
    'Annual', 
    'info', 
    'Has cerrado el ejercicio 2023 logrando mantener el equilibrio en tu utilidad acumulada, lo que demuestra tu capacidad de gestión para navegar un año fiscal sin incurrir en pérdidas que destruyan el valor de la firma. Es un punto de partida neutral y seguro que te permite planificar con la cabeza fría los próximos pasos para escalar tus ingresos anuales.', 
    'Mantener una utilidad acumulada plana durante todo un ejercicio significa que estás trabajando solo para cubrir tus gastos operativos mínimos, sin generar un excedente real para tus sueños. Estás en una zona de confort peligrosa donde cualquier imprevisto leve en un contrato clave podría empujarte hacia el terreno de las pérdidas operativas reales de inmediato si no reaccionas con prontitud gerencial.', 
    'Debes romper el techo de cristal de la utilidad plana implementando un plan de incentivos por metas de rentabilidad neta para tu equipo comercial. Enfoca todos tus esfuerzos de venta en aquellos tipos de consultoría que te dejan un margen superior y que demandan menos soporte administrativo. Solo así lograrás que la utilidad acumulada crezca de manera sólida y sostenida periodo tras periodo.', 
    'Bloque B - Auditoría Anual 2023', 
    'antigravity', 
    NOW()
) ON CONFLICT (empresa_id, indicador_key, periodo_ano, period_key) 
...
INSERT INTO insights (
    ...
    'Cerrar con un margen neto negativo del -33.91% significa que por cada peso que vendiste, perdiste mas de treinta centavos adicionales de tu propia ganancia acumulada. Estás en una situación donde tu operación no solo no es rentable, sino que está destruyendo activamente el capital propio que has invertido con tanto esfuerzo durante años en tu proyecto de consultoría.', 
...
INSERT INTO insights (
    ...
    'Annual', 
    'success', 
    'Tu margen bruto se mantiene firme en el 100% durante el 2024, reafirmando la pureza y potencia de tu modelo de negocio de servicios basados en el conocimiento. No tienes el peso de inventarios o costos de mercancía, lo cual es la mejor noticia posible para tu capacidad de maniobra frente a la incertidumbre económica y la volatilidad de los precios externos.', 
...
INSERT INTO insights (
    ...
    'Annual', 
    'success', 
    'Has logrado que tu patrimonio crezca espectacularmente hasta los 24.9 millones de pesos en 2024, lo cual indica que la empresa se ha fortalecido institucionalmente. Este crecimiento de tu base de capital propio es la mejor prueba de que tu proyecto de consultoría MAS CONSULTA está madurando y convirtiéndose en una organización con respaldo real para sus socios fundadores.', 
    'Debes monitorear que este incremento patrimonial no provenga únicamente de deudas o valorizaciones contables abstractas que no tengan un respaldo real en caja líquida para el ejercicio. Un patrimonio grande es inútil si la empresa atraviesa crisis de liquidez puntuales que no le permitan cumplir con sus obligaciones corrientes de corto plazo, por lo que debes vigilar tu solvencia total mensualmente.', 
    'Utiliza este patrimonio fortalecido como palanca para buscar mejores condiciones de crédito o inversión para tu crecimiento futuro. Tienes ahora una base sólida que te posiciona como un jugador serio en el mercado de la consultoría estratégica. Te recomiendo seguir capitalizando una porción de tus ingresos para que tu patrimonio siga siendo tu escudo protector ante cualquier tormenta económica futura.', 
    'Bloque B - Auditoría Anual 2024', 
    'antigravity', 
    NOW()
) ON CONFLICT (empresa_id, indicador_key, periodo_ano, period_key) 
...
INSERT INTO insights (
    ...
    'Annual', 
    'success', 
    'Has alcanzado un ROA del 19.66% en 2024, superando con creces los estándares ideales de rentabilidad sobre tus activos totales. Esto significa que cada peso que tienes invertido en computadores, software y activos financieros está produciendo casi veinte centavos de utilidad neta, demostrando una eficiencia en el uso de los recursos corporativos que pocos dueños de negocio logran alcanzar.', 
...
INSERT INTO insights (
    ...
    'Aunque es positivo, un margen neto del 10% está justo en el umbral mínimo aceptable para una firma de consultoría de tu alto nivel técnico y especialización. Estás operando con un margen de seguridad muy estrecho donde cualquier imprevisto fiscal o una caída en la facturación mensual podría borrar rápidamente tu ganancia neta, dejándote sin liquidez propia para el futuro mediato.', 
    'Enfoca tus esfuerzos comerciales en capturar contratos de mayor valor agregado que te permitan subir este margen neto hasta el quince o veinte por ciento anual. Debes analizar la rentabilidad específica de cada uno de tus consultores senior para asegurarte de que cada hora que ellos invierten en los clientes esté maximizando tu beneficio neto final y garantizando tu estabilidad financiera.', 
    'Bloque B - Auditoría Anual 2025', 
    'antigravity', 
    NOW()
) ON CONFLICT (empresa_id, indicador_key, periodo_ano, period_key) 
