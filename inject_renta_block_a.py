...
def inject_batch(payloads, batch_size=5, delay=8, inter_record_delay=3.5):
    print(f"Inyectando {len(payloads)} registros de Rentabilidad Bloque A...")
...
def get_bloque_a(empresa_id):
    records = []
    
    # ----- 2025 -----
    records.append({
        "empresa_id": empresa_id,
        "indicador_key": "insight-rentabilidad-ai",
        "periodo_ano": 2025,
        "period_key": "Annual",
        "tipo": "success",
        "titulo": "Auditoría Anual de Rentabilidad 2025",
    ...
    records.append({
        "empresa_id": empresa_id, "indicador_key": "insight-rentabilidad-ai_1Q", "periodo_ano": 2025, "period_key": "1Q", "tipo": "success", "titulo": "Rentabilidad del Primer Trimestre 2025",
        ...
        "metodologia": "Bloque A - Rentabilidad - Dictamen Trimestral", "generado_por": "antigravity"
    })
    records.append({
        "empresa_id": empresa_id, "indicador_key": "insight-rentabilidad-ai_2Q", "periodo_ano": 2025, "period_key": "2Q", "tipo": "success", "titulo": "Rentabilidad del Segundo Trimestre 2025",
    ...
    records.append({
        "empresa_id": empresa_id, "indicador_key": "insight-rentabilidad-ai_3Q", "periodo_ano": 2025, "period_key": "3Q", "tipo": "info", "titulo": "Rentabilidad del Tercer Trimestre 2025",
    ...
    records.append({
        "empresa_id": empresa_id, "indicador_key": "insight-rentabilidad-ai_4Q", "periodo_ano": 2025, "period_key": "4Q", "tipo": "warning", "titulo": "Rentabilidad del Cuarto Trimestre 2025",
    ...
    records.append({
        ...
        "period_key": "Annual",
        "tipo": "success",
        "titulo": "Auditoría Anual de Rentabilidad 2024",
    ...
    records.append({
        "empresa_id": empresa_id, "indicador_key": "insight-rentabilidad-ai_1Q", "periodo_ano": 2024, "period_key": "1Q", "tipo": "info", "titulo": "Rentabilidad del Primer Trimestre 2024",
    ...
    records.append({
        "empresa_id": empresa_id, "indicador_key": "insight-rentabilidad-ai_2Q", "periodo_ano": 2024, "period_key": "2Q", "tipo": "info", "titulo": "Rentabilidad del Segundo Trimestre 2024",
    ...
    records.append({
        "empresa_id": empresa_id, "indicador_key": "insight-rentabilidad-ai_3Q", "periodo_ano": 2024, "period_key": "3Q", "tipo": "info", "titulo": "Rentabilidad del Tercer Trimestre 2024",
    ...
    records.append({
        "empresa_id": empresa_id, "indicador_key": "insight-rentabilidad-ai_4Q", "periodo_ano": 2024, "period_key": "4Q", "tipo": "info", "titulo": "Rentabilidad del Cuarto Trimestre 2024",
    ...
    records.append({
        ...
        "period_key": "Annual",
        "tipo": "warning",
        "titulo": "Auditoría Anual de Rentabilidad 2023",
    ...
    records.append({
        "empresa_id": empresa_id, "indicador_key": "insight-rentabilidad-ai_1Q", "periodo_ano": 2023, "period_key": "1Q", "tipo": "warning", "titulo": "Rentabilidad del Primer Trimestre 2023",
    ...
    records.append({
        "empresa_id": empresa_id, "indicador_key": "insight-rentabilidad-ai_2Q", "periodo_ano": 2023, "period_key": "2Q", "tipo": "warning", "titulo": "Rentabilidad del Segundo Trimestre 2023",
    ...
    records.append({
        "empresa_id": empresa_id, "indicador_key": "insight-rentabilidad-ai_3Q", "periodo_ano": 2023, "period_key": "3Q", "tipo": "warning", "titulo": "Rentabilidad del Tercer Trimestre 2023",
    ...
    records.append({
        "empresa_id": empresa_id, "indicador_key": "insight-rentabilidad-ai_4Q", "periodo_ano": 2023, "period_key": "4Q", "tipo": "warning", "titulo": "Rentabilidad del Cuarto Trimestre 2023",
...
if __name__ == "__main__":
    empresa_id = int(sys.argv[1]) if len(sys.argv) > 1 else 3104
    payloads = get_bloque_a(empresa_id)
    inject_batch(payloads)
    print(f"\nProceso Finalizado. Se inyectaron correctamente {len(payloads)} registros maestros.")
