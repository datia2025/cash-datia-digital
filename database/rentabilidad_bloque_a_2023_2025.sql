...
INSERT INTO insights_ai (
    ...
    'Bloque A - Rentabilidad - Dictamen Trimestral', 
    'antigravity'
) ON CONFLICT (empresa_id, indicador_key, periodo_ano, COALESCE(period_key, 'Annual')) 
DO UPDATE SET 
    tipo = EXCLUDED.tipo,
...
INSERT INTO insights_ai (
    ...
    3104, 
    'insight-rentabilidad-ai_2Q', 
    2025, 
    '2Q', 
    'success', 
    'Rentabilidad del Segundo Trimestre 2025', 
    'El segundo trimestre fue un momento excelente donde viste cómo tus reportes de utilidad alcanzaban niveles ideales al empezar a cobrar los hitos intermedios de tus grandes proyectos. Ese cruce entre trabajar rápido y no inflar tu nómina te dejó un margen operativo impecable, comprobando que vender consultoría inteligente y sin tanta burocracia es el camino ideal para que te lleves más plata a casa.', 
    'Lo que sí afectó silenciosamente este segundo trimestre fueron las horas extra y los reprocesos que pidieron tus clientes más exigentes justo antes de darte el visto bueno para facturar. Esos ajustes interminables, que nadie te paga adicionalmente, actuaron como un hueco en tu bolsillo, consumiendo horas de tus mejores consultores y evitando que la ganancia de esos meses fuera perfecta.', 
    'Tienes que ser mucho más firme en cómo cierras los acuerdos, poniendo un límite claro a cuántas veces le puedes cambiar un documento al cliente sin cobrarle de más. Si alguien pide más revisiones de las acordadas, cóbraselas como horas extras de consultoría; así cuidas tu ganancia bruta y evitas que los clientes abusen del tiempo de tu equipo de expertos.', 
    'Bloque A - Rentabilidad - Dictamen Trimestral', 
    'antigravity'
) ON CONFLICT (empresa_id, indicador_key, periodo_ano, COALESCE(period_key, 'Annual')) 
DO UPDATE SET 
...
INSERT INTO insights_ai (
    ...
    'A partir de las lecciones del 2023, la regla de oro debe ser integrar siempre un gran colchón de imprevistos comerciales de hasta el 15% dentro del costo total de tus consultorías macro. Ese margen de colchón servirá como paracaídas salvador para que jamás vuelva a pasar que los gastos ocultos, notariales o logísticos de tu operación diaria terminen devorando íntegramente toda tu ansiada y merecida rentabilidad.', 
    'Bloque A - Rentabilidad - Dictamen Maestro 2023', 
    'antigravity'
) ON CONFLICT (empresa_id, indicador_key, periodo_ano, COALESCE(period_key, 'Annual')) 
DO UPDATE SET 
    tipo = EXCLUDED.tipo,
...
INSERT INTO insights_ai (
    ...
    '3Q', 
    'warning', 
    'Rentabilidad del Tercer Trimestre 2023', 
