...
FILE_DIR = r"c:\Users\gutie\OneDrive\FERFILES\DATIA\PROPUESTAS\COLOMBIA\MASCONSULTA\Master Account"
...
if __name__ == "__main__":
    # Corremos en el puerto 8888 para que sea el unico servicio web local
